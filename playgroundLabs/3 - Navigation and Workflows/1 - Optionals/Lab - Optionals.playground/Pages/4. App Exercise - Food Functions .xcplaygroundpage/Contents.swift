...
if let breakfast = getMeal(for: "Breakfast") {
    print("Breakfast logged: \(breakfast.food), \(breakfast.calories) calories")
} else {
    print("No Breakfast logged.")
}

if let dinner = getMeal(for: "Dinner") {
    print("Dinner logged: \(dinner.food), \(dinner.calories) calories")
} else {
    print("No Dinner logged.")
}
/*:
...
print("Meal log retrieved: \(mealLog)")
