...
let returnedAge1 = checkAge("25")
print("Returned age: \(returnedAge1)")

let returnedAge2 = checkAge("17")
print("Returned age: \(returnedAge2)")

let returnedAge3 = checkAge("abc")
print("Returned age: \(returnedAge3)")
...
let cost = getItemCost(itemName: "Chips")
