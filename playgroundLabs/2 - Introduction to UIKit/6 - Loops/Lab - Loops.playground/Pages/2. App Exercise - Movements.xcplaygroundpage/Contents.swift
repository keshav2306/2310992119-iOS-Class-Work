...
var movementHeartRate: [String: Int] = ["Walking": 85, "Running": 120, "Swimming": 130, "Cycling": 128, "Skiing": 114, "Climbing": 129]
...
for (movement,heartRate) in movementHeartRates{
    print("Your average heart  rate during \(movements) is \(heartRate) bpm")
}
